...
create or replace trigger check_round_number_before_insert_scores before insert
or
update on scores for each row
execute function check_round_number ();

create or replace trigger check_round_number_before_insert_hole_scores before insert
or
